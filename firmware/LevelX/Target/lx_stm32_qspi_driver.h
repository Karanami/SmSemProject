...
#define LX_STM32_QSPI_DUMMY_CYCLES_READ_QUAD_STR      0xFF
#define LX_STM32_QSPI_BULK_ERASE_MAX_TIME             0xFF
#define LX_STM32_QSPI_DUMMY_CYCLES_READ_QUAD          0xFF
#define LX_STM32_QSPI_PAGE_SIZE                       0xFF
#define LX_STM32_QSPI_DIE_ERASE_MAX_TIME              0xFF
#define LX_STM32_QSPI_SECTOR_ERASE_MAX_TIME           0xFF
#define LX_STM32_QSPI_VCR_NB_DUMMY                    0xFF
#define LX_STM32_QSPI_SR_WREN                         0xFF
#define LX_STM32_QSPI_SR_WEN                          0xFF
#define LX_STM32_QSPI_SR_WIP                          0xFF
#define LX_STM32_QSPI_BULK_ERASE_CMD                  0xFF

#define LX_STM32_QSPI_GET_STATUS_REG_CMD              0xFF
#define LX_STM32_QSPI_QUAD_INOUT_FAST_READ_CMD        0xFF
#define LX_STM32_QSPI_QUAD_IN_FAST_PROG_CMD           0xFF
#define LX_STM32_QSPI_DIE_ERASE_CMD                   0xFF
#define LX_STM32_QSPI_SECTOR_ERASE_CMD                0xFF
#define LX_STM32_QSPI_RESET_ENABLE_CMD                0xFF
#define LX_STM32_QSPI_RESET_MEMORY_CMD                0xFF
#define LX_STM32_QSPI_READ_VOL_CFG_REG_CMD            0xFF
#define LX_STM32_QSPI_WRITE_VOL_CFG_REG_CMD           0xFF
#define LX_STM32_QSPI_WRITE_ENABLE_CMD                0xFF
#define LX_STM32_QSPI_READ_STATUS_REG_CMD             0xFF
#define LX_STM32_QSPI_ENTER_QUAD_CMD                  0xFF
#define LX_STM32_QSPI_ENTER_4_BYTE_ADDR_MODE_CMD      0xFF
#define LX_STM32_QSPI_SUBSECTOR_ERASE_CMD             0xFF
